    ...
    <div className="card" style={{ maxWidth: 400, boxShadow: '0 6px 32px 0 rgba(123, 63, 63, 0.12)', padding: '2.5rem 2rem' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
        ...
        <div style={{ marginBottom: 8, display: 'flex', alignItems: 'center' }}>
          <input type="checkbox" id="remember" style={{ width: 16, height: 16, marginRight: 6 }} />
      ...
      <div style={{ textAlign: 'center', margin: '1.5rem 0 0.5rem 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ color: '#7b3f3f', fontWeight: 600 }}>OR</span>
          <hr style={{ flex: 1, border: 'none', borderTop: '1.5px solid #b97a7a' }} />
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', gap: 16, marginTop: 12 }}>
          <button type="button" style={{ background: '#fff', color: '#7b3f3f', border: '1.5px solid #b97a7a', width: 48, height: 48, borderRadius: 12, fontSize: 22, display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Login with Google">G</button>
          <button type="button" style={{ background: '#fff', color: '#7b3f3f', border: '1.5px solid #b97a7a', width: 48, height: 48, borderRadius: 12, fontSize: 22, display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Login with Facebook">f</button>
          <button type="button" style={{ background: '#fff', color: '#7b3f3f', border: '1.5px solid #b97a7a', width: 48, height: 48, borderRadius: 12, fontSize: 22, display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Login with X">X</button>
        </div>
      </div>
